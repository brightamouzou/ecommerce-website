import { Color, Artcile, descriptions_lifestyle } from "./article.js";
...
const article5 = new Artcile(
  ...
  "men",
  [color51],
  descriptions_lifestyle[4]
);

"https://static.nike.com/a/images/t_PDP_144_v1/f_auto/go9ejlsilpz2hq0eophu/chaussure-air-max-plus-pour-nnTrAZe0.png";


const elements=[article1,article2,article3, article4, article5];

// const fetchingAll = Promise.all(
//   elements.map(async (ele, idx) => {
